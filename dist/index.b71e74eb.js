...
let users = [];
const allUserInfo = localStorage.getItem("allUserInfo");
console.log(allUserInfo);
const allUserInfoList = JSON.parse(allUserInfo);
...
logInBtn.addEventListener("click", (e)=>{
    ...
    getData();
    setLoginUser(users);
    if (!Object.values(users).find((user)=>username === user.username && password === user.password)) alert("User not found");
});
...
},{}]},["3LmCz","h7u1C"], "h7u1C", "parcelRequire33f3")
