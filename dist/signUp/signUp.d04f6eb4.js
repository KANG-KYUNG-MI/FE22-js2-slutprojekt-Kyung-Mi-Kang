...
})({"yP6ux":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "3e036a97d04f6eb4";
"use strict";
...
},{}],"fVsYV":[function(require,module,exports) {
...
// console.log(allInfo);
let id = Object.values(allInfo).length;
console.log(id);
const form = document.getElementById("form");
let enterPassword = document.getElementById("enterPassword");
let enterName = document.getElementById("enterName");
let enterPicture = document.getElementById("enterPicture");
let insertBtn = document.getElementById("insert");
let signUpBtn = document.getElementById("ConfirmSignUp");
let newUser = {
    id: 0,
    username: "",
    password: "",
...
async function postItem(newUser) {
    const url = `https://js2-slutprojekt-default-rtdb.europe-west1.firebasedatabase.app/users.json`;
    const init = {
        method: "POST",
...
},{}]},["yP6ux","fVsYV"], "fVsYV", "parcelRequire33f3")

//# sourceMappingURL=signUp.d04f6eb4.js.map
